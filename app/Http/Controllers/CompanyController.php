...
class CompanyController extends Controller
{
    ...
    public function indexAjax()
    {
        ...
        foreach($companies as $company)
        {
            ...
            $spanFinalized = "<a href='".route('finalized',$company->id)."' style='cursor:pointer;color:#F39C12;'>".count(Sale::where('company_id',$company->id)->where('status','Finalizado')->get())."<span title='Finalizados...' class='icon icon-smile'></span></a>&nbsp;&nbsp;";
