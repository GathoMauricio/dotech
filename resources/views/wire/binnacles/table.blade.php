...
<table class="table table-bordered">
    ...
    @foreach ($binnacles as $binnacle)
        <tr>
            ...
            <select id="cbo_company_binnacle_{{ $binnacle->id }}" class="form-control" style="width:100%;">
            ...
            <br/>
            <button onclick = "asignarCompaniaBitacora({{ $binnacle->id }});" class="btn btn-primary btn-block">Asignar</button>
            @else
            ...
            <td width="15%" class="text-center font-weight-bold">
                <br/>
                <input id="txt_alias_binnacle_{{ $binnacle->id }}"  type="text" value = "{{ $binnacle->alias }}" class="form-control" placeholder="Alias...">
                <br/>
                <button onclick = "asignarAliasBitacora({{ $binnacle->id }});" class="btn btn-primary btn-block">Asignar</button>
            </td>
            @endif
            ...
            <td width="15%">
                ...
                <br>
                <a href="javascript:void(0);" onclick="viewBinnacleImages({{ $binnacle->id }},{{ count(App\BinnacleImage::where('binnacle_id',$binnacle->id)->get()) }})">
