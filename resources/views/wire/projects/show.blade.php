...
-->
            ...
            <center>
                <table class="table" border="1">
                    ...
                    <tr>
                        ...
                        <td style="padding:5px;">
                            <center>
                                <a href="#">
                                    <span onclick="createWhitdrawal();" class="icon-credit-card"
                ...
                <table style="width:100%;">
                    <tr>
                        <td onclick="showCotizadoTab('cotizado');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Cotizado
                        </td>
                        <td onclick="showCotizadoTab('productos');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Productos
                        </td>
                        <td onclick="showCotizadoTab('pagos');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Pagos
                        </td>
                        <td onclick="showCotizadoTab('archivos');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Archivos
                        </td>
                        <td onclick="showCotizadoTab('retiros');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Retiros
                        </td>
                        <td onclick="showCotizadoTab('bitacoras');" class="text-center font-weight-bold"
                            style="background-color:#d30035;color:white;cursor:pointer;">
                            Bitacoras
                        </td>
                    </tr>
                ...
                <div id="cotizado_container_tab">
                    <table class="table" border="5">
                        ...
                        <tr>
                            <td colspan="5" style="word-wrap:break-word;"><b>Observaciones:</b>
                                {{ $sale->observation }}</td>
                        </tr>
                    </table>
                </div>
                ...
                -->
                    ...
                    -->
                            ...
                            <tr>
                                <td colspan="7" class="text-right">IVA: ${{ number_format($totalProductIva, 2) }}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7" class="text-right">Total:
                                    ${{ number_format($totalProduct + $totalProductIva, 2) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <td colspan="4" style="background-color:#d30035;color:white;font-weight:bold;">
                                <center>
                                    ...
                                    <label style="float:right;padding:5px;"><span
                                            onclick="addSalePaymentModal({{ $sale->id }});" class="icon-plus"
                                            style="cursor:pointer;color:white;"
                                            title="Agregar pago..."></span></label>
                                </center>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                ...
                                @if (!empty($payment->document))
                                    <td class="text-center"><a
                                            href="{{ 'http://dotech.dyndns.biz:16666/dotech/public/storage/' . $payment->document }}"
                                            target="_BLANK"><span class="icon-eye"></span></a></td>
                                @else
                                    <td class="text-center"><a href="#"><span class="icon-upload"></span></a>
                                    </td>
                                @endif
                            </tr>
                        @endforeach
                ...
                <div id="archivos_container_tab" style="display:none;">
                    <table class="table" border="5">
                            ...
                            <td colspan="4" style="background-color:#d30035;color:white;font-weight:bold;">
                                <center>
                                    ...
                                    <label style="float:right;padding:5px;"><span
                                            ...
                                            style="cursor:pointer;color:white;"
                                            title="Agregar archivo..."></span></label>
                                </center>
                            </td>
                        </tr>
                        <tr>
                        ...
                        @foreach ($documents as $document)
                            <tr>
                                <td><a href ="javascript:void(0);" class="text-red"
                                        onclick ="eliminarDocumento({{ $document->id }})">Eliminar</a></td>
                                <td>{{ formatDate($document->created_at) }}</td>
                                <td>{{ $document->description }}</td>
                                <td class="text-center"><a
                                        href="{{ 'http://dotech.dyndns.biz:16666/dotech/public/storage/' . $document->document }}"
                                        target="_BLANK"><span class="icon-eye"></span></a></td>
                            </tr>
                        @endforeach
                    ...
                    <table class="table" border="5">
                        <tr>
                            <td colspan="9" style="background-color:#d30035;color:white;font-weight:bold;">
                                <center>
                                    <label>Retiros</label>
                                    <label style="float:right;padding:5px;"><span onclick="createWhitdrawal();"
                                            class="icon-plus" style="cursor:pointer;color:white;"
                                            title="Solicitar retiro..."></span></label>
                                </center>
                            </td>
                        </tr>
                    </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::user()->rol_user_id == 1 && $whitdrawal->status == 'Pendiente')
                                            <br />
                                            <a href="#"
                                                onclick="aproveWithdrawalModal({{ $whitdrawal->id }});"><span
                                                    class="icon-checkmark"></span> Aprobar</a>
                                        @endif
                                        @if ($whitdrawal->status == 'Pendiente')
                                            <br />
                                            <a href="#" class="text-red"
                                                onclick="eliminarRetiro({{ $whitdrawal->id }});"><span
                                                    class="icon-bin"></span> Eliminar</a>
                                        @endif
                                    </td>

                                    <td>
                                        <input type="text"
                                            onkeyUp="updateWhitdrawalFolio({{ $whitdrawal->id }},this.value);"
                                            value="{{ $whitdrawal->folio }}" />
                                    ...
                                    @if ($whitdrawal->invoive == 'SI')
                                        @if (!empty($whitdrawal->document))
                                            <td class="text-center"><a
                                                    href="{{ 'http://dotech.dyndns.biz:16666/dotech/public/storage/' . $whitdrawal->document }}"
                                                    target="_BLANK"><span class="icon-eye"></span></a></td>
                                        @else
                                            <td class="text-center"><a href="#"
                                                    onclick="addWhitdralDocumentModal({{ $whitdrawal->id }});"><span
                    ...
                    -->
                        ...
                        @foreach ($binnacles as $binnacle)
                            <tr>
                                ...
                                <td>{{ $binnacle->author['name'] }} {{ $binnacle->author['middle_name'] }}
                                    {{ $binnacle->author['last_name'] }}</td>
                                <td>{{ $binnacle->description }}</td>
                                <td>
                                    @if (!empty($binnacle->firm))
                                        <img src="{{ asset('storage') }}/{{ $binnacle->firm }}" width="80"
                                            height="80">
                                    @else
                                ...
                                <td>
                                    ...
                                    <br>
                                    <a href="#"
                                        onclick="viewBinnacleImages({{ $binnacle->id }},{{ count(App\BinnacleImage::where('binnacle_id', $binnacle->id)->get()) }},'{{ route('binnacle_images', $binnacle->id) }}')">
                ...
                @if ($sale->status != 'Rechazada')
                    ...
                    @else
                        @if (Auth::user()->rol_user_id == 1)
                            <a href="#" onclick="setProjectAsFinish({{ $sale->id }})"
                                class="font-weight-bold link-sys">[Marcar proyecto como finalizado]</a>
                        @endif
                    @endif
                @endif
                <br />
                ...
                <input type="hidden" id="txt_view_binnacle_images_route"
                    value="{{ route('binnacle_images_index') }}">
            ...
            <script>
                jQuery(document).ready(function() {
                    $("#index_table_retiros").dataTable({
                        ...
                        oLanguage: {
                            sLengthMenu: "_MENU_ ",
                            sInfo: "<b>Se muestran de _START_ a _END_ elementos de _TOTAL_ registros en total</b>",
