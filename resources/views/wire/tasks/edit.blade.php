<!-- Modal -->
<div wire:ignore.self class="modal fade" id="edit_task" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="archived">Archivada</label>
                            <select  wire:model="archived"class="form-control" >
                                <option value>--Seleccione una opción--</option>
                                <option value="NO">NO</option>
                                <option value="SI">SI</option>
                            </select>
                            @error('archived') <span class="error-message">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
