                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="txt_add_product_modal_quantity" type="number" name="quantity" value="1"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input id="txt_add_product_modal_measure" type="text" name="measure"
                                    class="form-control">
                            </div>
                        </div>
                        {{--  <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="txt_add_product_modal_unity_price_sell"
                                    name="unity_price_sell" value="1" min="1" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
