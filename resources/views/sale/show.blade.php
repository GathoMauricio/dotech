        ...
        <table class="table" border="1">
            ...
            <tr>
                ...
                <td style="padding:5px;">
                    <center>
                        <a href="#">
                            <span onclick="addSaleWhitdrawal({{ $sale->id }});" class="icon-credit-card"
                ...
                <tr>
                    <td colspan="4" style="background-color:#d30035;color:white;font-weight:bold;">
                        <label style="float:right;padding:5px;">
                            <span onclick="editarProyecto(0);" class="icon-pencil" style="cursor:pointer;color:white;"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Auth::user()->rol_user_id == 1 && $whitdrawal->status == 'Pendiente')
                                    <br />
                                    <a href="#" onclick="aproveWithdrawalModal({{ $whitdrawal->id }});"><span
                                            class="icon-checkmark"></span> Aprobar</a>
                                @endif
                            </td>

                            <td width="40%;">
                                <input type="text" onkeyUp="updateWhitdrawalFolio({{ $whitdrawal->id }},this.value);"
                                    value="{{ $whitdrawal->folio }}" class="form-control" />
                ...
                <tr>
                    <td colspan="6" style="background-color:#d30035;color:white;font-weight:bold;">
                        <center>
                            ...
                            <label style="float:right;padding:5px;"><span onclick="addBinnacle({{ $sale->id }});"
