...
<div class="wrapper">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          @if(auth('clients')->user()->image == 'compania.png')
            <img src="{{ asset('img/'.auth('clients')->user()->image) }}" class="img-circle elevation-2" alt="User Image"  width="60" height="60" />
          @else
            <img src="{{ asset('storage/'.auth('clients')->user()->image) }}" class="img-circle elevation-2" alt="User Image"  width="60" height="60" />
          @endif
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="{{ route('clients_dashboard') }}" class="nav-link @if (Route::currentRouteName() == 'clients_dashboard') active @endif">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="p-3">
      ...
      <form id="logout-form" action="{{ route('clients_logout') }}" method="POST" style="display: none;">
      @csrf
      </form>
    </div>
  </aside>
