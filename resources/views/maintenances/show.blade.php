...
@section('content')
    ...
    <table style="width:100%;">
        <tr>
            <th colspan="6" class="text-center font-weight-bold" style="background-color:#d30035;color:white;">Informació
                general</th>
        </tr>
        <tr>
        ...
        <tr>
            <td width="20%" style="background-color:#D5D8DC;">{{ $maintenance->author['name'] }}
                {{ $maintenance->author['middle_name'] }} {{ $maintenance->author['last_name'] }}</td>
        ...
        <thead>
            <tr>
                <th colspan="3" class="text-center" style="background-color:#d30035;color:white;">
                    <a href="#" onclick="addMaintenanceImage({{ $maintenance->id }})" title="Añadir"
        ...
        <tbody>
            @foreach ($images as $image)
                <tr>
                    ...
                    @if (Auth::user()->rol_user_id == 1)
                        <td>
                            <a href="#" onclick="deleteMaintenanceImage({{ $image->id }})"><span class="icon-bin"
