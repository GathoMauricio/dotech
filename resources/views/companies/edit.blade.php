...
@section('content')
    ...
    <form action="{{ route('update_company', $company->id) }}" method="POST" accept-charset="UTF-8"
                    ...
                    <div class="form-group">
                        ...
                        <select name="origin" class="custom-select" required>
                            ...
                            @foreach ($origenes as $origen)
                                @if ($origen->origen == $company->origin)
                                    <option value="{{ $origen->origen }}" selected>{{ $origen->origen }}</option>
                                @else
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="porcentaje" class="custom-select" required>
                            <option value>--Seleccione una opciópn--</option>
                            @if ($company->porcentaje == 8)
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="responsable" value="{{ $company->responsable }}" type="text" class="form-control"
                            required>
                    </div>
                </div>
                <div class="col-md-4">
