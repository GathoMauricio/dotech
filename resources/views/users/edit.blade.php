...
@section('content')
    ...
    <form action="{{ route('update_user', $user->id) }}" method="POST" accept-charset="UTF-8"
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="middle_name" value="{{ old('middle_name', $user->middle_name) }}" type="text"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="emergency_phone" value="{{ old('emergency_phone', $user->emergency_phone) }}"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="fecha_contrato" class="font-weight-bold color-primary-sys">
                            Fecha de contrato
                        </label>
                        <input type="date" name="fecha_contrato"
                            value="{{ old('fecha_contrato', $user->fecha_contrato) }}" class="form-control">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirm" id="txt_edit_password_confirm"
                            class="form-control" required>
                    </div>
                </div>
            </div>
        ...
        <tr>
            <td colspan="9" style="background-color:#d30035;color:white;font-weight:bold;">
                <center>
                    ...
                    <label style="float:right;padding:5px;"><span onclick="addUserDocument({{ $user->id }});"
                            class="icon-plus" style="cursor:pointer;color:white;"
                            title="Agregar documento..."></span></label>
                </center>
            </td>
        </tr>
    </table>
        ...
        <tbody>
            @foreach ($documents as $document)
                <tr>
                    ...
                    <td><a href="{{ asset('storage') }}/{{ $document->document }}"
                            target="_blank">{{ $document->document }}</a></td>
                    @if (Auth::user()->rol_user_id == 1)
                        <td>
                            <a href="#" onclick="deleteUserDocument({{ $document->id }});"><span class="icon-bin"
