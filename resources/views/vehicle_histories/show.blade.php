...
@section('content')
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td width="15%" style="background-color:#D5D8DC;">{{ $history->vehicle['brand'] }}
                {{ $history->vehicle['model'] }}</td>
            ...
            <td width="25%" style="background-color:#D5D8DC;">{{ $history->author['name'] }}
                {{ $history->author['middle_name'] }} {{ $history->author['last_name'] }}</td>
        </tr>
    </table>
    <br />
        ...
        <tbody>
            @foreach ($images as $image)
                <tr>
                    ...
                    <th>{{ $image->author['name'] . ' ' . $image->author['middle_name'] . ' ' . $image->author['last_name'] }}
                    </th>
                    <td>
                        @if ($image->source == 'API')
