    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar prospecto</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @else
                                    <center><strong id="txt_edit_porcentaje"></strong></center>
                                    <input type="hidden" name="porcentaje" id="cbo_edit_porcentaje" readonly>
                                @endif
                            </div>
                        </div>
                    </div>
