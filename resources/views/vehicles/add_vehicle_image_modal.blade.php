<!-- Modal -->
<div class="modal fade" id="add_vehicle_image_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('store_vehicle_image') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
