        ...
        <div class="row">
            <div class="col-md-8 p-3" style="background-color: white;border: solid 5px #f4f6f9;">
                @if (Auth::user()->rol_user_id == 1)
                    <a href="javascript:void(0);"><span class="icon icon-pencil float-right"></span></a>
                    <h5>Contacto</h5>
                @endif
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 p-2">
                        <a href="#" class="btn btn-primary">Iniciar cotización</a>
                    </div>
                    <div class="col-md-3 p-2">
                        <a href="#" class="btn btn-primary">({{ $cliente->seguimientos->count() }}) Seguimientos</a>
                    </div>
                    <div class="col-md-3 p-2">
                        <a href="#" class="btn btn-primary">({{ $cliente->repositorios->count() }}) Repositorios</a>
                    </div>
                    <div class="col-md-3 p-2">
                        <a href="#" class="btn btn-primary">({{ $cliente->documentaciones->count() }})
                            Documentación</a>
                    </div>
                </div>
            </div>
